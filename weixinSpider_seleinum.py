...
#    driver.find_element_by_xpath('//*[@id="myform"]/div[3]/div[1]/div/label[2]').click()
    ...
    # 点击搜索
    driver.find_element_by_xpath('//*[@id="myform"]/div[3]/div[3]/div[1]/div/span[1]/a[2]/i').click()
    time.sleep(3)
    # 点击第一个公众号
    driver.find_element_by_xpath('//*[@id="myform"]/div[3]/div[3]/div[2]/div/div[1]/div/div[1]/div[3]/p[1]').click()
    time.sleep(3)
